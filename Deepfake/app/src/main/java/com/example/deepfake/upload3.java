...
//        intent.setType("application/jpg");
    ...
    private void uploadImageFileFirebase(Uri data) {
        ...
        final String image_name3 = "upload"+System.currentTimeMillis()+".jpg";

        StorageReference reference = storageReference.child(image_name3);
...
//                        tv1.setText(uri.toString());
                        ...
                        Toast.makeText(upload3.this, "File is Uploaded", Toast.LENGTH_SHORT).show();
                        SharedPreferences prefos = getApplicationContext().getSharedPreferences("xyz", 0);
                        SharedPreferences.Editor editor = prefos.edit();
                        editor.putString("link3", image_name3);
                        editor.apply();
                        progressDialog.dismiss();
                        Intent picture_intent = new Intent(upload3.this,upload4.class);
